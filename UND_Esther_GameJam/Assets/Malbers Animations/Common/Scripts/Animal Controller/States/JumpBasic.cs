...
namespace MalbersAnimations.Controller
{
    ...
    public class JumpBasic : State
    {
        ...
        public override void Activate()
        {
            ...
            PlatFormInertia = animal.DeltaPlatformPos; //Get the Inertia from the platform to apply it on the jump if needed
            ...
            var fallState = animal.State_Get<Fall>();

            if (fallState != null)
            {
                fallState.PlatFormInertia = animal.DeltaPlatformPos; //Get the Inertia from the platform to apply it on the fall if needed
            }
