...
namespace MalbersAnimations.Controller
{
    public abstract class State : ScriptableObject
    {
        ...
        [HideInInspector] public List<ModeID> SleepFromMode = new();
        [HideInInspector] public List<StateID> SleepFromState = new();
        [HideInInspector] public List<ModeID> DisableModes = new();
        [HideInInspector] public List<StateID> QueueFrom = new();
        ...
        internal EnterExitIDEvent<StateID> EnterExitEvent;
